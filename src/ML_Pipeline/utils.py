...
# Function to check GPU information and TensorFlow version
def check_gpu_info():
    print("Tensorflow version : ", tf.__version__)
    print("GPU available : ", bool(tf.test.is_gpu_available))
    print("GPU name : ", tf.test.gpu_device_name())

# Function to load and display dataset details
...
# Function to load and convert the dataset into Pandas DataFrames
